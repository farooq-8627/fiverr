...
import { UserProfile } from "@/components/Onboarding/UserProfile/context/UserProfileFormContext";
          ...
          <AnimatePresence>
            {hasCompany && (
              ...
              >
                ...
                <motion.div variants={itemVariants}>
                  <Textarea
                    placeholder="Tell us about your company's mission and expertise... (Bio)"
                    value={company.bio || ""}
                    onChange={(e) =>
                      updateCompany({
                        bio: e.target.value,
